...
from agentsjson.core.utils import convert_dot_digits_to_brackets
from agentsjson.core.models.auth import AuthConfig, AuthType, OAuth1AuthConfig, UserPassCredentials, OAuth2AuthConfig
from agentsjson.core.parsetools import ToolFormat
from agentsjson.core.models.schema import AgentsJson, Flow, Link
...
def _execute(bundle: Optional[Bundle], flow: Flow, auth: AuthConfig, parameters: Dict[str, Any], requestBody: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for action in flow.actions:
        ...
        from ..agents_json.integrations import roblox
        integration_module = roblox
