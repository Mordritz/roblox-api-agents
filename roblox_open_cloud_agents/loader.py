...
from agentsjson.core.models.schema import Flow, AgentsJson, Override, Source
...
def load_agents_json(filename: str):
    current_dir = os.path.dirname(os.path.abspath(__file__))
    parent_dir = os.path.dirname(current_dir)
    schema_dir = os.path.join(parent_dir, "agents_json", "roblox", filename)
